...
<body>
    ...
    <main>
        ...
        <div class="main-div">
            ...
            if (!empty($articletagstime) && !empty($articletagsplace)) {
                $products = mysqli_query($connect, "SELECT * FROM `Items` WHERE `tag2` = '$articletagstime' AND `tag1` = '$articletagsplace'");
            } else if (empty($articletagsplace)) {
                $products = mysqli_query($connect, "SELECT * FROM `Items` WHERE `tag2` = '$articletagstime'");
            } else {
                $products = mysqli_query($connect, "SELECT * FROM `Items` WHERE `tag1` = '$articletagsplace'");
            }
